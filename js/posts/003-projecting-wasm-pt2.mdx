...
So it's nice that this works, but there's one glaring problem. I have to
run `wasm-pack` prior to running my Gatsby build. Ideally, I would just have to
run `gatsby build` and have my whole site built for me.
